...
set "SOURCE1=C:\Users\OBAC\Documents\MM\TEMP nie usuwaj - Lenovo E14\TEMP - tru"
set "DEST1=D:\ARCHIWUM\Work\Laborex\1.Laborex_backup_Dokuments_folder_MM\MM\TEMP nie usuwaj - Lenovo E14\TEMP - tru"
...
:: ------------------------------------------------------------------------------------------------------------------
robocopy "%SOURCE1%" "%DEST1%" /MIR /DCOPY:T /COPY:DAT /MT:4 /R:2 /W:3 /NP /LOG:"%~dp0%LOGDATE%-Kopia_2TB_TEMP - tru_.log" /TEE
:: ------------------------------------------------------------------------------------------------------------------
echo === [1/2] Zakończono
echo.
