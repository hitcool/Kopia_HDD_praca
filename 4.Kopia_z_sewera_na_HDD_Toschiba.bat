...
set "DEST=D:\ARCHIWUM\Work\Laborex\2.Laborex_backup_serwer_folder_MM\MM"
:: -----------------------------------------------------------------------
...
:: --------------------------------------------------------------------------------------------------------------------
robocopy "%SOURCE%" "%DEST%" /MIR /R:3 /W:3 /NP /MT:8 /LOG:"%~dp0%LOGDATE%-Kopia_z_Serwera_na_HDD_.log" /TEE /XD "%SOURCE%\OBAC"
:: --------------------------------------------------------------------------------------------------------------------
